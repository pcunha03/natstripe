...
export declare enum StripeStandardPaymentMethodType {
    Card = "card",
    ApplePay = "applePay",
    Fpx = "fpx"
}
...
export declare const enum StripeStandardBillingAddressFields {
    None = 0,
    Zip = 1,
    Full = 2,
    Name = 3
...
export declare const enum StripeStandardShippingAddressField {
    Name = "name",
